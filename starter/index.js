...
//funtion for generating html file
function generateHTML() {
  if (!fs.existsSync(OUTPUT_DIR)) {
    fs.mkdirSync(OUTPUT_DIR);
  }
  const renderedHTML = render(teamMembers);
  fs.writeFileSync(outputPath, renderedHTML); // takes the place where will html be generated, and the contend generated by render function
